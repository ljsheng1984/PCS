<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yhklist.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.yhklist" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div class="cont">
            <div class="cont2">
                <div class="opera">
                    <p>
                        <img src="/ljsheng/images/16.png" /> 银行卡：<input type="text" id="yhk" runat="server" class="txt1" />
                ...
                <div class="content">
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td><%# Eval("yhk")%><asp:Label ID="gid" runat="server" Text='<%# Eval("gid") %>' Visible="false" /></td>
                                <td>
                                ...
                                <td><a href="javascript:showiframe('<%# Eval("yhk")%>','yhkau.aspx?gid=<%#Eval("gid") %>')">修改</a> | <asp:Button ID="del" runat="server" Text="删除" CssClass="btn2" CommandName="del" OnClientClick="return confirm('确定删除吗？');" /></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
                            <div>当前没有符合条件的数据</div>
