<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webau.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.webau" %>
<!DOCTYPE html>
        ...
        <div class="cont">
            <table id="add">
                <tr>
                    <th>危害网址：</th>
                    <td>
                        <input type="text" runat="server" id="url" value="http://" class="txt url" minlength="2" maxlength="100" /><em class="tip"></em></td>
                </tr>
