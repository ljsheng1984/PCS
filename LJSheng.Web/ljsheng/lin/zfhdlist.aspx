<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zfhdlist.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.zfhdlist" %>
                    ...
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a target="_blank" href="<%#  LJSheng.Data.Helps.zhuanfa + Eval("tupian") %>"><img  width="50" height="50" src="<%#  LJSheng.Data.Helps.zhuanfa + Eval("tupian") %>" onerror="this.src='/ljsheng/images/nopic.png'" /></a></td>
                                <td><asp:Label ID="hygid" runat="server" Text='<%# Eval("hygid") %>' Visible="false" />
