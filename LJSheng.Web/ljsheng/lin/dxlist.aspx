<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dxlist.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.dxlist" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div class="cont">
            <div class="cont2">
                <div class="opera">
                    <p>
                        <img src="/ljsheng/images/16.png" /> 短信内容：<input type="text" id="duanxin" runat="server" class="txt1" /> 类型:<asp:DropDownList ID="lxDDL" runat="server"></asp:DropDownList>
                    ...
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="javascript:showiframe('<%# Eval("duanxin")%>','dxau.aspx?gid=<%#Eval("gid") %>')">修改</a> | <asp:Button ID="del" runat="server" Text="删除" CssClass="btn2" CommandName="del" OnClientClick="return confirm('确定删除吗？');" /></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
                            <div>当前没有符合条件的数据</div>
