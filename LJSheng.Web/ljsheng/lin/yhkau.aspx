<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yhkau.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.yhkau" %>
<!DOCTYPE html>
        ...
        <div class="cont">
            <table id="add">
                <tr>
                    <th>防骗银行卡号码：</th>
                    <td>
                        <input type="text" runat="server" id="yhk" class="txt required" onkeyup="value=value.replace(/[^\d]/g,'');" minlength="2" maxlength="50" /><em class="tip"></em></td>
                </tr>
