<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zidian.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.zidian" %>
            ...
            <div class="cont2">
                <div class="opera">
                    <div class="p">
                        ...
                        字典类型：<input type="text" id="zd" runat="server" class="txt1" />
                ...
                <div class="opera">字典类型:<input type="text" id="zdlx" runat="server" class="txt1" /> 介绍:<input type="text" id="jshao" runat="server" class="txt1" /> 排序:<input type="text" runat="server" value="0" id="px" style="width:20px;" class="txt" onkeyup="value=value.replace(/[^\d]/g,'');" /> <asp:Button runat="server" ID="ok" Text="增加字典" OnClick="ok_Click" CssClass="btn2" /></div>
                <div class="content">
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td title="<%# Eval("gid") %>"><%# Eval("zdlx") %><asp:Label ID="gid" runat="server" Text='<%# Eval("gid") %>' Visible="false" /></td>
                                ...
                                <td>
                                    <asp:Button ID="Button1" runat="server" Text="更新" CssClass="btn2" CommandName="up" /> <asp:Button ID="del" runat="server" Text="删除" CssClass="btn2" CommandName="del" OnClientClick="return confirm('确定删除吗？');" />
                                    <hr />
                                    <a class="btn2" href="javascript:showiframe('<%# Eval("zdlx")%>','zdlist.aspx?gid=<%#Eval("gid") %>')">键值管理</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
