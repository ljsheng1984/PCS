<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jiance.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.jiance" %>
<!DOCTYPE html>
                    ...
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="javascript:showiframe('<%# Eval("duanxin")%>','dxau.aspx?jcgid=<%#Eval("gid") %>')">加入防骗模版</a> <br /> <asp:Button ID="del" runat="server" Text="删除" CssClass="btn2" CommandName="del" OnClientClick="return confirm('确定删除吗？');" /></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
                            <div>当前没有符合条件的数据</div>
