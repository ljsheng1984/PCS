<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="glylist.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.glylist" %>
            ...
            <div class="cont2">
                <div class="opera">
                    <p>
                        ...
                        登录名：<input type="text" id="zhanghao" runat="server" class="txt1" />
                    ...
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href='glyau.aspx?gid=<%#Eval("gid") %>'>修改</a> | <asp:Button ID="del" runat="server" Text="删除" CssClass="btn2" CommandName="del" OnClientClick="return confirm('确定删除吗？');" /></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
                            <div>当前没有符合条件的数据</div>
