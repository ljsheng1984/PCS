<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yjtp.aspx.cs" Inherits="LJSheng.Web.ljsheng.lin.yjtp" %>
            ...
            <div class="cont2">
                <div class="opera">
                    <p>
                        ...
                        反馈主题：<input type="text" id="wenti" runat="server" class="txt1" /> 用户：<input type="text" id="zhanghao" runat="server" class="txt1" />
                    ...
                    <asp:ListView ID="LVljsheng" runat="server" OnItemCommand="LVljsheng_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a target="_blank" href="<%# LJSheng.Data.Helps.yjfk +Eval("tupian") %>"><img  width="50" height="50" src="<%# LJSheng.Data.Helps.yjfk + Eval("tupian") %>" onerror="this.src='/ljsheng/images/nopic.png'" /></a></td>
                                <td><%# Eval("zhanghao")%></td>
                                <td>
