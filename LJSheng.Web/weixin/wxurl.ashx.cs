    ...
    public class wxurl : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Request.HttpMethod == "GET")
            {
                ...
                {
                    //linjiansheng.WriteLog(echostr, "开发者验证"); //返回随机字符串则表示验证通过
            ...
            else
            {
                ...
                using (Stream stream = HttpContext.Current.Request.InputStream)
                {
                    ...
                    Handle(postString);
                    LJSheng.Common.LogManager.WriteLog("微信请求", postString);
                }
            }
        }
        ...
        public static void Handle(string postStr)
        {
            ...
            LJSheng.Common.LogManager.WriteLog("回复微信", responseContent);
